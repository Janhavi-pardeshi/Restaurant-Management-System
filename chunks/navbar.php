<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">RESTRO</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="index.php" class="hvr-grow">Home</a></li>
		        <li><a href="about-RESTRO.php" class="hvr-grow">About Us</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/RESTRO">Home</a></li>
	        <li><a href="/RESTRO/about-RESTRO.php">About Us</a></li>
	        <li><a href="food-categories.php">Categories</a></li>
	        <li><a href="foods.php">Foods</a></li>
	        <li><a href="#" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91-987-654-3210. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
